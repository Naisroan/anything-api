using anything_api.Common.Http;
using ErrorOr;
...
namespace anything_api.Common.Errors;

public class ErrorsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public ErrorsFactory(ApiBehaviorOptions options)
    {
        _options = options ?? throw new ArgumentException(nameof(ApiBehaviorOptions));
    }
